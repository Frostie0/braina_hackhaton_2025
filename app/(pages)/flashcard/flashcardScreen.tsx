  ...
  return (
    <div className="min-h-screen bg-black flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 max-w-2xl mx-auto w-full">
        <div
          className="w-full max-w-xl aspect-[3/4] relative perspective-1000 cursor-pointer"
          onClick={handleFlip}
        >
          <motion.div
          ...
          >
            ...
            >
              ...
              {showHint && currentCard.hint && (
                <p className="mt-4 text-sm text-center text-gray-300 max-w-sm">
                  {currentCard.hint}
                </p>
              )}
              ...
              {currentCard.hint && (
                <button
                  ...
                  className="absolute bottom-8 left-8 p-3 rounded-full bg-white/10 hover:bg-white/20 transition-all z-50 group"
                  title={showHint ? "Masquer l'indice" : "Afficher l'indice"}
                >
                  <Lightbulb className={`w-5 h-5 transition-all ${showHint ? 'text-yellow-400 opacity-100' : 'text-white opacity-60 group-hover:opacity-100'}`} />
                </button>
              )}
            </div>
            ...
            >
              <p className="text-lg lg:text-xl text-center font-medium leading-relaxed text-gray-200">

...
export const metadata: Metadata = {
  ...
  description: "Utilisez l'IA pour générer instantanément des quiz, des flashcards et des podcasts éducatifs à partir de vos documents. Apprenez plus intelligemment avec Braina.",
  keywords: ["IA", "Quiz", "Flashcards", "Éducation", "Apprentissage", "Génération automatique", "Études"],
  ...
  openGraph: {
    ...
    description: "Transformez n'importe quel contenu en matériel d'étude interactif en quelques secondes.",
    siteName: "Braina",
    images: [
      {
        url: "/opengraph-image",
  ...
  twitter: {
    ...
    description: "Générez des quiz et flashcards à partir de vos cours en un clic.",

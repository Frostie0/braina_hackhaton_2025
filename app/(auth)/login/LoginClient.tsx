    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                if (user) saveUserData({ userId: user.userId, name: user.name, email: user.email });
            ...
            if (error.response) {
                ...
                if (status === 401) setErrors({ general: 'Email ou mot de passe incorrect' });
                else if (status === 404) setErrors({ general: 'Utilisateur non trouvé' });
        ...
        <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="mb-8 text-center">
                    ...
                    <h1 className="text-3xl font-serif font-medium text-white mb-2">Bon retour</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center gap-2 text-gray-400 cursor-pointer hover:text-gray-300 transition-colors">
                                <input type="checkbox" className="rounded border-gray-700 bg-gray-800 text-purple-500 focus:ring-purple-500/20" />
                                Se souvenir de moi
                            </label>
                            <a href="#" className="text-gray-400 hover:text-white transition-colors">Mot de passe oublié ?</a>
                        </div>
